...
my $deat1max = 30.0; # max limit
my $deat1_max = 30.0; # running max initial
my $deat2min = 5.0;
my $deat2_min = 5.0;
my $deat2max = 30.0;
my $deat2_max = 30.0;
